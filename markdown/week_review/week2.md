...
**Would like to see the YouTube video you watched about logistic map embedded in this report somewhere if possible.  CONOR.**
...
**Would be useful to include a link to the useful website - CONOR.**
...
**Don't forget that the code you wrote with your friend used a for loop to append values to two arrays.  We then looked at list comprehensions and wrote the code above which is even more concise, easy to read and possibly slightly faster.  CONOR.**
...
**Would look nicer if you edited the Drawing function to make the page smaller so that the crosses filled it better.  Currently a huge amount of wasted white space around this plot/image.  CONOR.**
...
**Would be useful to record the ffmpeg command that you used here.  Might be good to discuss the simpler one first, then note the problem with the colours and then discuss the more complicated one you ended up using.  Could be good to say what you think about ffmpeg.  Easy or difficult to use?  Powerful?  Easy to learn about it?  Do you think it does a lot of things?  Do many other people use it?  Can you use it on many different operating systems?  CONOR.**
